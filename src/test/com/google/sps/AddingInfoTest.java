...
public final class AddingInfoTest {
  ...
  public void AddingNewSchoolShouldAddNewSchool() {
    ...
    PostRequestMaker modelRequest =
        PostRequestMaker.makeResponse("MIT", "6.006", "Spring 2020", 12, "Jason Ku");
    PostRequestMaker modelResponse = PostRequestMaker.makeRequest();
    AddSchoolInfo.addSchoolData(db, modelRequest, modelResponse);

    Filter schoolFilter =
        new FilterPredicate(
            "school-name", FilterOperator.EQUAL, modelRequest.getParameter("class-name"));
  ...
  public void AddingNewSchoolShouldAddNewCourse() {
    ...
    Filter schoolFilter =
        new FilterPredicate(
            "course-name", FilterOperator.EQUAL, modelRequest.getParameter("course-name"));
