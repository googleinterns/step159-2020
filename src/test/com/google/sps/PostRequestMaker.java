...
public final class PostRequestMaker {
  public HttpRequest makeRequest(
      String schoolName, String courseName, String termName, Int units, String profName) {
    var values =
    ...
    HttpRequest request =
        HttpRequest.newBuilder()
            .uri(
                URI.create(
                    "https://8080-4b5d82bb-74f0-46b0-a124-e91877782c7c.s-west1.cloudshell.dev/add-info"))
