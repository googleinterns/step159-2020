...
//     Date startTime = foundTerm.getProperty("timeStamp");
...
//     Query courseQuery =
//         new
// Query("Course").setAncestor(schoolKey).setFilter(CompositeFilterOperator.and(filters));
//     Key courseKey =
...
//     Query termQuery = new Query("Term").setAncestor(courseKey).addSort("timeStamp",
// SortDirection.DESCENDING).setFilter(timeFilter);
//     List<Entity> foundTerms = db.prepare(termQuery).asList(FetchOptions.Builder.withDefaults());
